    ...
    elseif contains(filename, 'Sin')
        ...
        if ~isempty(SinOD)
            ...
            if isempty(tblDataSin)
                tblDataSin = table({fName}, {'OD 1st Harm'}, Sin.Amps(1), Sin.Amps(2), Sin.Amps(3), Sin.Amps(4), Sin.Amps(5), Sin.Amps(6), Sin.Amps(7), Sin.Amps(8), Sin.Amps(9), Sin.Amps(10), Sin.Amps(11), Sin.Amps(12), Sin.Amps(13), Sin.Amps(14), Sin.Amps(15), Sin.Amps(16), Sin.Amps(17),...
                ...
                tblDataSin = [tblDataSin; table({fName}, {'OD 1st Harm'}, Sin.Amps(1), Sin.Amps(2), Sin.Amps(3), Sin.Amps(4), Sin.Amps(5), Sin.Amps(6), Sin.Amps(7), Sin.Amps(8), Sin.Amps(9), Sin.Amps(10), Sin.Amps(11), Sin.Amps(12), Sin.Amps(13), Sin.Amps(14), Sin.Amps(15), Sin.Amps(16), Sin.Amps(17),...
            ...
            tblDataSin = [tblDataSin; table({fName}, {'OD 2nd Harm'}, Sin.Amps2(1), Sin.Amps2(2), Sin.Amps2(3), Sin.Amps2(4), Sin.Amps2(5), Sin.Amps2(6), Sin.Amps2(7), Sin.Amps2(8), Sin.Amps2(9), Sin.Amps2(10), Sin.Amps2(11), Sin.Amps2(12), Sin.Amps2(13), Sin.Amps2(14), Sin.Amps2(15), Sin.Amps2(16), Sin.Amps2(17),...
                                    'VariableNames', {'FileName', 'Eye', 'f50hz', 'f45hz', 'f40hz', 'f35hz', 'f30hz', 'f25hz', 'f20hz', 'f15hz', 'f10hz', 'f7hz', 'f5hz', 'f3hz', 'f2hz', 'f1hz', 'f07hz', 'f05hz', 'f03hz'})]; %#ok
        ...
        if ~isempty(SinOS)
            Sin = SinOS;
            if isempty(tblDataSin)
                tblDataSin = table({fName}, {'OS 1st Harm'}, Sin.Amps(1), Sin.Amps(2), Sin.Amps(3), Sin.Amps(4), Sin.Amps(5), Sin.Amps(6), Sin.Amps(7), Sin.Amps(8), Sin.Amps(9), Sin.Amps(10), Sin.Amps(11), Sin.Amps(12), Sin.Amps(13), Sin.Amps(14), Sin.Amps(15), Sin.Amps(16), Sin.Amps(17),...
                                    'VariableNames', {'FileName', 'Eye', 'f50hz', 'f45hz', 'f40hz', 'f35hz', 'f30hz', 'f25hz', 'f20hz', 'f15hz', 'f10hz', 'f7hz', 'f5hz', 'f3hz', 'f2hz', 'f1hz', 'f07hz', 'f05hz', 'f03hz'});
            else
                tblDataSin = [tblDataSin; table({fName}, {'OS 1st Harm'}, Sin.Amps(1), Sin.Amps(2), Sin.Amps(3), Sin.Amps(4), Sin.Amps(5), Sin.Amps(6), Sin.Amps(7), Sin.Amps(8), Sin.Amps(9), Sin.Amps(10), Sin.Amps(11), Sin.Amps(12), Sin.Amps(13), Sin.Amps(14), Sin.Amps(15), Sin.Amps(16), Sin.Amps(17),...
                                    'VariableNames', {'FileName', 'Eye', 'f50hz', 'f45hz', 'f40hz', 'f35hz', 'f30hz', 'f25hz', 'f20hz', 'f15hz', 'f10hz', 'f7hz', 'f5hz', 'f3hz', 'f2hz', 'f1hz', 'f07hz', 'f05hz', 'f03hz'})]; %#ok
            end
            tblDataSin = [tblDataSin; table({fName}, {'OS 2st Harm'}, Sin.Amps2(1), Sin.Amps2(2), Sin.Amps2(3), Sin.Amps2(4), Sin.Amps2(5), Sin.Amps2(6), Sin.Amps2(7), Sin.Amps2(8), Sin.Amps2(9), Sin.Amps2(10), Sin.Amps2(11), Sin.Amps2(12), Sin.Amps2(13), Sin.Amps2(14), Sin.Amps2(15), Sin.Amps2(16), Sin.Amps2(17),...
                                    'VariableNames', {'FileName', 'Eye', 'f50hz', 'f45hz', 'f40hz', 'f35hz', 'f30hz', 'f25hz', 'f20hz', 'f15hz', 'f10hz', 'f7hz', 'f5hz', 'f3hz', 'f2hz', 'f1hz', 'f07hz', 'f05hz', 'f03hz'})]; %#ok
        end
    end
end
